                              ...
                              <div class="row mb-3">
                                  <div class="col-md-6">
                                      <div class="form-floating mb-3 mb-md-0">
                                          <input class="form-control allow-alphanumeric" id="inputName" type="text" placeholder="Enter name" required name="name_of_enquiry" minlength="3"/>
                                          <label for="inputName">Name</label>
                                      </div>
                                  </div>
                                  <div class="col-md-6">
                                      <div class="form-floating">
                                          <input class="form-control allow-number" id="inputContactnumber" type="text" placeholder="Conatct Number" required name="contact_number" minlength="10" maxlength="10" />
                                          <label for="inputContactnumber">Contact Number</label>
                                      </div>
                                  </div>
                              </div>
                              <div class="form-floating mb-3">
                                  <input class="form-control allow-email" id="inputEmail" type="email" placeholder="name@example.com" required name="email_address" />
